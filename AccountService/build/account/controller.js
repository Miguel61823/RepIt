...
let AccountController = class AccountController extends tsoa_1.Controller {
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return new service_1.AccountService().getAll();
        });
    }
    addAccount(userData) {
        return __awaiter(this, void 0, void 0, function* () {
            return new service_1.AccountService().getByEmail(userData.email)
                ...
                if (found) {
                    ...
                    return yield new service_1.AccountService().addAccount(userData);
                }
            }));
        });
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AccountController.prototype, "addAccount", null);
