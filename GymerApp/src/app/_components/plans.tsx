      ...
      <div className="grid md:grid-cols-3 gap-8">
        <Card className="overflow-hidden flex flex-col h-full text-black dark:text-white bg-black">
          <CardHeader>
            ...
            <CardDescription className="mt-2 text-black dark:text-white font-bold text-3xl">
              $9.99<span className="text-sm font-thin">/month</span>
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter>
            <Button variant="wide">Choose Plan</Button>
          </CardFooter>
        </Card>
        ...
        <Card className="overflow-hidden flex flex-col h-full text-black dark:text-white  bg-black">
          <CardHeader>
            ...
            <CardDescription className="mt-2 text-black dark:text-white font-bold text-3xl">
              $19.99<span className="text-sm font-thin">/month</span>
            </CardDescription>
          </CardHeader>
          <CardContent className="p-4 flex-grow">
            <ul className="mb-6">
        ...
        <Card className="overflow-hidden flex flex-col h-full text-black dark:text-white bg-black">
          <CardHeader>
            ...
            <CardDescription className="mt-2 text-black dark:text-white font-bold text-3xl">
              $29.99<span className="text-sm font-thin">/month</span>
            </CardDescription>
          </CardHeader>
          <CardContent className="p-4 flex-grow">
            <ul className="mb-6">
